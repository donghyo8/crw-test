...
for i in range(132,646):
    urlString = "https://www.jeju.go.kr/finance/contract/private/service.htm?ctrtKindCd=2&ctrtMeth=4&page=" + str(i)
...
workbook.save('contractName_Jeju.xls')
